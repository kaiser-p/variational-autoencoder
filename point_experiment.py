...
def generate_data(target_dir, num_examples, img_w=100, img_h=100, num_points=1, point_color="white"):
...
if __name__ == "__main__":
    ...
    generate_data(data_dir, args.num_images, img_h=args.img_size, img_w=args.img_size)
